...
nx affected:e2e`),n()()(),e(168,"p",54),t(169," Carefully crafted with "),r(),e(170,"svg",55),i(171,"path",56),n()()()())},dependencies:[h],styles:[`
    ...
    `],encapsulation:2});let l=a;return l})();var k=(()=>{let a=class a{constructor(){this.title="speed-run"}};a.\u0275fac=function(m){return new(m||a)},a.\u0275cmp=s({type:a,selectors:[["speed-run-root"]],standalone:!0,features:[d],decls:2,vars:0,template:function(m,E){m&1&&i(0,"speed-run-nx-welcome")(1,"router-outlet")},dependencies:[w,v,b]});let l=a;return l})();var S=[];var y={providers:[u(),x(S)]};var C={providers:[f()]},z=c(y,C);var V=()=>g(k,z),J=V;export{J as a};
